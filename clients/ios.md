...
- **Web browser (mobile Safari/Chrome)** — FOSS/Free. Navidrome's web UI works well on mobile browsers and is the recommended quick option.

Notes:

- Please verify exact license/pricing and compatibility for each app — I could not confirm all details from here.
